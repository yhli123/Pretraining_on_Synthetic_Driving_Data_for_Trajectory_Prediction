...
def learning_rate_decay(args, i_epoch, optimizer, optimizer_2=None):
    ...
    if 'set_predict' in args.other_params:
        ...
        # if i_epoch % 5 == 0: # Backup code for continuing FT
...
def demo_basic(rank, world_size, kwargs, queue):
    ...
    if world_size > 0:
        ...
        if args.pretrain_label:
            ...
            # model.load_state_dict \
            #    (torch.load(os.path.join(args.model_save_dir, "model.1.bin")),
            #     strict=True)
    ...
    if args.pretrain_label:
        ...
        # Backup code for continuing FT
        # optimizer.load_state_dict \
        #        (torch.load(os.path.join(args.model_save_dir, "optim.5.bin"))[0])
        # optimizer_2.load_state_dict \
        #        (torch.load(os.path.join(args.model_save_dir, "optim.5.bin"))[1])
